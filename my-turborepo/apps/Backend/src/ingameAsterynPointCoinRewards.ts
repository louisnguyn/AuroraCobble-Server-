 ...
 * Not 1:1 — in-game Points and website Coins are separate currencies.
 */
...
export const INGAME_AP_TO_WEBSITE_COIN_TABLE: ReadonlyArray<{ label: string; coins: number }> = [
  { label: "Rank 1", coins: 50 },
  { label: "Rank 2", coins: 48 },
  { label: "Rank 3", coins: 45 },
  { label: "Rank 4–5", coins: 40 },
  { label: "Rank 6–8", coins: 35 },
  { label: "Rank 9–10", coins: 30 },
  { label: "Rank 11–15", coins: 20 },
  { label: "Rank 16–20", coins: 10 },
];
