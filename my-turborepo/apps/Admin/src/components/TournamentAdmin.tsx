    ...
    <div className="w-full max-w-6xl mx-auto space-y-5 pb-16 text-left">
      <header className="space-y-1">
        ...
        <p className="text-sm text-muted m-0">
          Manage brackets, publish events, and configure Asteryn Coin predictions from the tabs below.
        </p>
      </header>
      ...
      {adminTab === 'predictions' ? (
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          <label className="block space-y-1">
            <span className="text-xs text-slate-400">Max stake (Asteryn Coin)</span>
            <input
              className={fieldClass}
              inputMode="numeric"
              value={predMaxStake}
      ...
      <section className={panelClass}>
        ...
        {betHistoryMeta ? (
          <p className="text-xs text-slate-300 m-0">
            ...
            {betHistoryMeta.totalStaked.toLocaleString()} Asteryn Coin total staked
          </p>
        ) : null}
