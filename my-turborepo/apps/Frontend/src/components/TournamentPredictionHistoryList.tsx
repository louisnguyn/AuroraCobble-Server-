          ...
          >
            ...
            {row.stakeChampion > 0 && (
              <p className="m-0 text-[#e2e8f0]">
                ...
                Asteryn Coin — <span className={champ.className}>{champ.label}</span>
              </p>
            )}
            {row.stakeRunnerUp > 0 && (
              <p className="m-0 text-[#e2e8f0]">
                ...
                Asteryn Coin — <span className={ru.className}>{ru.label}</span>
              </p>
            )}
            <p className="m-0 text-xs text-muted tabular-nums">
              Total staked {row.totalStake.toLocaleString()} Asteryn Coin
            </p>
          </li>
        )
      })}
