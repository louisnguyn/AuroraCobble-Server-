...
/** In-game Asteryn Coin top 20 — RCON `asterynpoint leaderboard`. Same JSON shape (`top10` may have up to 20). */
...
/** Website wallet Asteryn Coin top 10 (`user_currency` on the API host). Same shape as in-game economy boards. */
