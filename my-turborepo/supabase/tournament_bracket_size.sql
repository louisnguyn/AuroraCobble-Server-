...
ALTER TABLE tournaments
  ADD CONSTRAINT tournaments_bracket_size_check CHECK (bracket_size IN (8, 12));

UPDATE tournaments SET bracket_size = 12 WHERE bracket_size IS NULL OR bracket_size NOT IN (8, 12);
